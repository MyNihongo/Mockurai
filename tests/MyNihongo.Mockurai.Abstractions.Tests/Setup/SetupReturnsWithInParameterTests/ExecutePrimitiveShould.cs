namespace MyNihongo.Mockurai.Abstractions.Tests.Setup.SetupReturnsWithInParameterTests;

public sealed class ExecutePrimitiveShould : SetupReturnsWithInParameterTestsBase
{
	[Fact]
	public void ReturnForAnySetup()
	{
		const string returnValue = nameof(returnValue);
		var setup = ItIn<int>.Any();
	...
	public void ReturnForValueSetup()
	{
		...
		var setup = ItIn<int>.Value(setupValue);
	...
	{
		const string returnValue = nameof(returnValue);
		var setup = ItIn<int>.Where(static x => x <= 10);
	...
	{
		const string errorMessage = nameof(errorMessage);
		var setup = ItIn<int>.Where(x => x <= 10);
	...
	public void PrioritiseWhereOverAnyReturns1()
	{
		...
		var setup1 = ItIn<int>.Any();

		const string returnValue2 = nameof(returnValue2);
		var setup2 = ItIn<int>.Where(static x => x > 10);
	...
	public void PrioritiseValueOverWhereReturns1()
	{
		...
		var setup3 = ItIn<int>.Value(setupValue3);
	...
	public void ReturnForAnySetupFunc()
	{
		...
		var fixture = CreateFixture<int, string>(setup);
		fixture.Returns(static (in x) => (x + 3).ToString());
	...
	public void ReturnDefaultForValueSetupFunc()
	{
		...
		var fixture = CreateFixture<int, int>(setup);
		fixture.Returns(static (in x) => x + 3);
	...
	{
		var fixture = CreateFixture<int, string>();
		fixture.SetupParameter(ItIn<int>.Any().ValueSetup);
		fixture.Callback(static (in _) => { });
		fixture.Throws(new Exception());
		fixture.Callback(static (in _) => { Debug.WriteLine("output"); });
		fixture.Throws(new Exception());
	...
	public void ReturnLastResultWhere()
	{
		...
		fixture.SetupParameter(ItIn<int>.Where(x => x > 10).ValueSetup);
		fixture.Returns("random text");

		const string returnValue = nameof(returnValue);
		fixture.SetupParameter(ItIn<int>.Where(x => x > 100).ValueSetup);
		fixture.Returns(returnValue);
	...
	public void ReturnLastResultValue()
	{
		...
		fixture.SetupParameter(ItIn<int>.Value(setupValue).ValueSetup);
		fixture.Returns("random text");
	...
	public void ReturnDifferentValuesWithCallback1()
	{
		...
		var fixture = CreateFixture<int, string>();
		fixture.SetupParameter(ItIn<int>.Any().ValueSetup);
		fixture.Callback((in _) => callback++);
		fixture.Returns(setupValue1);
		fixture.Returns(setupValue2);
	...
	public void ReturnDifferentValuesWithCallback4()
	{
		...
		var fixture = CreateFixture<int, string>();
		fixture.SetupParameter(ItIn<int>.Any().ValueSetup);
		fixture.Callback((in _) => callback1++);
		fixture.And();
		fixture.Returns(setupValue1);
		fixture.Returns(setupValue2);
		fixture.And();
		fixture.Callback((in _) => callback2++);
