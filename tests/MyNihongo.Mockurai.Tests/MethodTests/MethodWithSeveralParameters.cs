...
public sealed class MethodWithSeveralParameters : MethodTestsBase
{
	...
	public async Task GenerateInterface()
	{
		...
		const string extensions =
			"""
			// Invoke
			public ISetup<SetupInt32Single.CallbackDelegate> SetupInvoke(in It<int> param1 = default, in It<float> param2 = default) =>
				((InterfaceMock)@this).SetupInvoke(param1, param2);

			public void VerifyInvoke(in It<int> param1, in It<float> param2, in Times times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times);

			public void VerifyInvoke(in It<int> param1, in It<float> param2, System.Func<Times> times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times());
			""";
		...
		const string sequenceExtensions =
			"""
			// Invoke
			public void Invoke(in It<int> param1, in It<float> param2)
			{
		...
		const string invocationContainer = "public System.Collections.Generic.IEnumerable<IInvocation<(int param1, float param2)>> Invoke => _mock._invoke0Invocation?.GetInvocationsWithArguments() ?? [];";
		...
		var generatedSources = CreateInterfaceGeneratedSources(methods, proxy, invocationContainer, verifyNoOtherCalls, invocations, extensions, sequenceExtensions, setupCode, invocationCode);
	...
	[Fact]
	public async Task GenerateInterfaceWithDefaultParam1()
	{
		const string method = "void Invoke(int param1, float param2 = 0f);";
	...
	[Fact]
	public async Task GenerateInterfaceWithDefaultParam2()
	{
		const string method = "void Invoke(int param1 = 1, float param2 = 0f);";
	...
	public async Task GenerateInterfaceReturn()
	{
		...
		const string extensions =
			"""
			// Invoke
			public ISetup<SetupSingleInt32<decimal>.CallbackDelegate, decimal, SetupSingleInt32<decimal>.ReturnsCallbackDelegate> SetupInvoke(in It<float> param1 = default, in It<int> param2 = default) =>
				((InterfaceMock)@this).SetupInvoke(param1, param2);

			public void VerifyInvoke(in It<float> param1, in It<int> param2, in Times times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times);

			public void VerifyInvoke(in It<float> param1, in It<int> param2, System.Func<Times> times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times());
			""";
		...
		const string sequenceExtensions =
			"""
			// Invoke
			public void Invoke(in It<float> param1, in It<int> param2)
			{
				var nextIndex = ((InterfaceMock)@this.Mock).VerifyInvoke(param1, param2, @this.VerifyIndex);
				@this.VerifyIndex.Set(nextIndex);
			}
		...
		const string invocationContainer = "public System.Collections.Generic.IEnumerable<IInvocation<(float param1, int param2)>> Invoke => _mock._invoke0Invocation?.GetInvocationsWithArguments() ?? [];";
	...
	public async Task GenerateInterfaceThreeParams()
	{
		...
		const string extensions =
			"""
			// Invoke
			public ISetup<SetupInt32SingleString.CallbackDelegate> SetupInvoke(in It<int> param1 = default, in It<float> param2 = default, in It<string> param3 = default) =>
				((InterfaceMock)@this).SetupInvoke(param1, param2, param3);

			public void VerifyInvoke(in It<int> param1, in It<float> param2, in It<string> param3, in Times times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, param3, times);

			public void VerifyInvoke(in It<int> param1, in It<float> param2, in It<string> param3, System.Func<Times> times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, param3, times());
			""";
		...
		const string sequenceExtensions =
			"""
			// Invoke
			public void Invoke(in It<int> param1, in It<float> param2, in It<string> param3)
			{
				var nextIndex = ((InterfaceMock)@this.Mock).VerifyInvoke(param1, param2, param3, @this.VerifyIndex);
				@this.VerifyIndex.Set(nextIndex);
			}
			""";
		...
		const string invocationContainer = "public System.Collections.Generic.IEnumerable<IInvocation<(int param1, float param2, string param3)>> Invoke => _mock._invoke0Invocation?.GetInvocationsWithArguments() ?? [];";
	...
	public async Task GenerateInterfaceGeneric1()
	{
		...
		const string extensions =
			"""
			// Invoke
			public ISetup<SetupT1Single<T>.CallbackDelegate> SetupInvoke<T>(in It<T> param1 = default, in It<float> param2 = default) =>
				((InterfaceMock)@this).SetupInvoke<T>(param1, param2);

			public void VerifyInvoke<T>(in It<T> param1, in It<float> param2, in Times times) =>
				((InterfaceMock)@this).VerifyInvoke<T>(param1, param2, times);

			public void VerifyInvoke<T>(in It<T> param1, in It<float> param2, System.Func<Times> times) =>
				((InterfaceMock)@this).VerifyInvoke<T>(param1, param2, times());
			""";
		...
		const string sequenceExtensions =
			"""
			// Invoke
			public void Invoke<T>(in It<T> param1, in It<float> param2)
			{
		...
		const string invocationContainer =
			"""
			public System.Collections.Generic.IEnumerable<IInvocation<(T param1, float param2)>> Invoke<T>()
			{
				_mock._invoke0Invocation ??= new InvocationDictionary();
				var invoke0Invocation = (InvocationT1Single<T>)_mock._invoke0Invocation.GetOrAdd(typeof(T), static key => new InvocationT1Single<T>($"IInterface.Invoke<{key.Name}>({{0}}, {{1}})"));
	...
	public async Task GenerateInterfaceGeneric2()
	{
		...
		const string extensions =
			"""
			// Invoke
			public ISetup<SetupInt32T1<T>.CallbackDelegate> SetupInvoke<T>(in It<int> param1 = default, in It<T> param2 = default) =>
				((InterfaceMock)@this).SetupInvoke<T>(param1, param2);

			public void VerifyInvoke<T>(in It<int> param1, in It<T> param2, in Times times) =>
				((InterfaceMock)@this).VerifyInvoke<T>(param1, param2, times);

			public void VerifyInvoke<T>(in It<int> param1, in It<T> param2, System.Func<Times> times) =>
				((InterfaceMock)@this).VerifyInvoke<T>(param1, param2, times());
			""";
		...
		const string sequenceExtensions =
			"""
			// Invoke
			public void Invoke<T>(in It<int> param1, in It<T> param2)
			{
				var nextIndex = ((InterfaceMock)@this.Mock).VerifyInvoke<T>(param1, param2, @this.VerifyIndex);
				@this.VerifyIndex.Set(nextIndex);
			}
		...
		const string invocationContainer =
			"""
			public System.Collections.Generic.IEnumerable<IInvocation<(int param1, T param2)>> Invoke<T>()
			{
				_mock._invoke0Invocation ??= new InvocationDictionary();
				var invoke0Invocation = (InvocationInt32T1<T>)_mock._invoke0Invocation.GetOrAdd(typeof(T), static key => new InvocationInt32T1<T>($"IInterface.Invoke<{key.Name}>({{0}}, {{1}})"));
				return invoke0Invocation.GetInvocationsWithArguments() ?? [];
	...
	public async Task GenerateInterfaceGeneric3()
	{
		...
		const string extensions =
			...
			public void VerifyInvoke<T>(in It<T> param1, in It<T> param2, System.Func<Times> times) =>
				((InterfaceMock)@this).VerifyInvoke<T>(param1, param2, times());
			""";
		...
		const string sequenceExtensions =
			"""
			// Invoke
			public void Invoke<T>(in It<T> param1, in It<T> param2)
			{
				var nextIndex = ((InterfaceMock)@this.Mock).VerifyInvoke<T>(param1, param2, @this.VerifyIndex);
				@this.VerifyIndex.Set(nextIndex);
			}
		...
		const string invocationContainer =
			"""
			public System.Collections.Generic.IEnumerable<IInvocation<(T param1, T param2)>> Invoke<T>()
			{
				_mock._invoke0Invocation ??= new InvocationDictionary();
				var invoke0Invocation = (InvocationT1T1<T>)_mock._invoke0Invocation.GetOrAdd(typeof(T), static key => new InvocationT1T1<T>($"IInterface.Invoke<{key.Name}>({{0}}, {{1}})"));
				return invoke0Invocation.GetInvocationsWithArguments() ?? [];
	...
	public async Task GenerateInterfaceGenericWithRef()
	{
		...
		const string extensions =
			...
			public void VerifyInvoke<T>(in ItRef<T> param1, in It<T> param2, System.Func<Times> times) =>
				((InterfaceMock)@this).VerifyInvoke<T>(param1, param2, times());
			""";
		...
		const string sequenceExtensions =
			"""
			// Invoke
			public void Invoke<T>(in ItRef<T> param1, in It<T> param2)
			{
				var nextIndex = ((InterfaceMock)@this.Mock).VerifyInvoke<T>(param1, param2, @this.VerifyIndex);
				@this.VerifyIndex.Set(nextIndex);
			}
	...
	public async Task GenerateInterfaceMultipleGeneric1()
	{
		...
		const string invocationContainer =
			"""
			public System.Collections.Generic.IEnumerable<IInvocation<(T1 param1, float param2)>> Invoke<T2, T1>()
			{
				_mock._invoke0Invocation ??= new InvocationDictionary<(System.Type, System.Type)>();
				var invoke0Invocation = (InvocationT1Single<T1>)_mock._invoke0Invocation.GetOrAdd((typeof(T2), typeof(T1)), static key => new InvocationT1Single<T1>($"IInterface.Invoke<{key.Item1.Name}, {key.Item2.Name}>({{0}}, {{1}})"));
				return invoke0Invocation.GetInvocationsWithArguments() ?? [];
	...
	public async Task GenerateInterfaceMultipleGeneric2()
	{
		...
		const string invocationContainer =
			"""
			public System.Collections.Generic.IEnumerable<IInvocation<(T1 param1, T2 param2)>> Invoke<T1, T2>()
			{
				_mock._invoke0Invocation ??= new InvocationDictionary<(System.Type, System.Type)>();
				var invoke0Invocation = (InvocationT1T2<T1, T2>)_mock._invoke0Invocation.GetOrAdd((typeof(T1), typeof(T2)), static key => new InvocationT1T2<T1, T2>($"IInterface.Invoke<{key.Item1.Name}, {key.Item2.Name}>({{0}}, {{1}})"));
				return invoke0Invocation.GetInvocationsWithArguments() ?? [];
	...
	public async Task GenerateInterfaceReturnGeneric2()
	{
		...
		const string extensions =
			"""
			// Invoke
			public ISetup<SetupInt32T1<T, decimal>.CallbackDelegate, decimal, SetupInt32T1<T, decimal>.ReturnsCallbackDelegate> SetupInvoke<T>(in It<int> param1 = default, in It<T> param2 = default) =>
				((InterfaceMock)@this).SetupInvoke<T>(param1, param2);
	...
	public async Task GenerateInterfaceWithIn()
	{
		...
		const string extensions =
			"""
			// Invoke
			public ISetup<SetupInInt32Single.CallbackDelegate> SetupInvoke(in ItIn<int> param1 = default, in It<float> param2 = default) =>
				((InterfaceMock)@this).SetupInvoke(param1, param2);

			public void VerifyInvoke(in ItIn<int> param1, in It<float> param2, in Times times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times);

			public void VerifyInvoke(in ItIn<int> param1, in It<float> param2, System.Func<Times> times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times());
			""";
		...
		const string sequenceExtensions =
			"""
			// Invoke
			public void Invoke(in ItIn<int> param1, in It<float> param2)
			{
				var nextIndex = ((InterfaceMock)@this.Mock).VerifyInvoke(param1, param2, @this.VerifyIndex);
				@this.VerifyIndex.Set(nextIndex);
			}
	...
	public async Task GenerateInterfaceWithInOut()
	{
		...
		const string extensions =
			"""
			// Invoke
			public ISetup<SetupInInt32OutSingle.CallbackDelegate> SetupInvoke(in ItIn<int> param1 = default, in ItOut<float> param2 = default) =>
				((InterfaceMock)@this).SetupInvoke(param1, param2);

			public void VerifyInvoke(in ItIn<int> param1, in ItOut<float> param2, in Times times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times);

			public void VerifyInvoke(in ItIn<int> param1, in ItOut<float> param2, System.Func<Times> times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times());
			""";
		...
		const string sequenceExtensions =
			"""
			// Invoke
			public void Invoke(in ItIn<int> param1, in ItOut<float> param2)
			{
				var nextIndex = ((InterfaceMock)@this.Mock).VerifyInvoke(param1, param2, @this.VerifyIndex);
				@this.VerifyIndex.Set(nextIndex);
			}
	...
	public async Task GenerateInterfaceReturnOutRef()
	{
		...
		const string extensions =
			"""
			// Invoke
			public ISetup<SetupOutInt32RefSingle<decimal>.CallbackDelegate, decimal, SetupOutInt32RefSingle<decimal>.ReturnsCallbackDelegate> SetupInvoke(in ItOut<int> param1 = default, in ItRef<float> param2 = default) =>
				((InterfaceMock)@this).SetupInvoke(param1, param2);

			public void VerifyInvoke(in ItOut<int> param1, in ItRef<float> param2, in Times times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times);

			public void VerifyInvoke(in ItOut<int> param1, in ItRef<float> param2, System.Func<Times> times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times());
			""";
		...
		const string sequenceExtensions =
			"""
			// Invoke
			public void Invoke(in ItOut<int> param1, in ItRef<float> param2)
			{
				var nextIndex = ((InterfaceMock)@this.Mock).VerifyInvoke(param1, param2, @this.VerifyIndex);
				@this.VerifyIndex.Set(nextIndex);
			}
	...
	public async Task GenerateInterfaceOutOut()
	{
		...
		const string extensions =
			"""
			// Invoke
			public ISetup<SetupOutInt32OutSingle.CallbackDelegate> SetupInvoke(in ItOut<int> param1 = default, in ItOut<float> param2 = default) =>
				((InterfaceMock)@this).SetupInvoke(param1, param2);

			public void VerifyInvoke(in ItOut<int> param1, in ItOut<float> param2, in Times times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times);

			public void VerifyInvoke(in ItOut<int> param1, in ItOut<float> param2, System.Func<Times> times) =>
				((InterfaceMock)@this).VerifyInvoke(param1, param2, times());
			""";
		...
		const string sequenceExtensions =
			"""
			// Invoke
			public void Invoke(in ItOut<int> param1, in ItOut<float> param2)
			{
				var nextIndex = ((InterfaceMock)@this.Mock).VerifyInvoke(param1, param2, @this.VerifyIndex);
				@this.VerifyIndex.Set(nextIndex);
			}
	...
	public async Task GenerateInterfaceReturnOutOut()
	{
		...
		const string extensions =
			"""
			// Invoke
			public ISetup<SetupOutInt32OutSingle<decimal>.CallbackDelegate, decimal, SetupOutInt32OutSingle<decimal>.ReturnsCallbackDelegate> SetupInvoke(in ItOut<int> param1 = default, in ItOut<float> param2 = default) =>
				((InterfaceMock)@this).SetupInvoke(param1, param2);
