...
public sealed class EventGenericShould : EventGenericTestsBase
{
	...
	public async Task GenerateInterfaceEvent2()
	{
		...
		const string methods =
			...
			{
				_handlerEvent0AddInvocation ??= new Invocation<System.EventHandler<string>?>($"IInterface<{typeof(T).Name}>.HandlerEvent.add += {{0}}");
				_handlerEvent0AddInvocation.Verify(value.ValueSetup, times, _invocationProviders);
			}
			...
			{
				_handlerEvent0RemoveInvocation ??= new Invocation<System.EventHandler<string>?>($"IInterface<{typeof(T).Name}>.HandlerEvent.remove -= {{0}}");
				_handlerEvent0RemoveInvocation.Verify(value.ValueSetup, times, _invocationProviders);
			}
		...
		const string proxy =
			...
			public event System.EventHandler<string>? HandlerEvent
			{
				add
				{
					_mock._handlerEvent0AddInvocation ??= new Invocation<System.EventHandler<string>?>($"IInterface<{typeof(T).Name}>.HandlerEvent.add += {{0}}");
					_mock._handlerEvent0AddInvocation.Register(_mock._invocationIndex, value);
					_mock._handlerEvent0 += value;
				}
				remove
				{
					_mock._handlerEvent0RemoveInvocation ??= new Invocation<System.EventHandler<string>?>($"IInterface<{typeof(T).Name}>.HandlerEvent.remove -= {{0}}");
					_mock._handlerEvent0RemoveInvocation.Register(_mock._invocationIndex, value);
					_mock._handlerEvent0 -= value;
				}
			}
	...
	public async Task GenerateInterfaceGenericEvent1()
	{
		...
		const string methods =
			...
			{
				_handlerEvent0AddInvocation ??= new Invocation<System.EventHandler<T>?>($"IInterface<{typeof(T).Name}>.HandlerEvent.add += {{0}}");
				_handlerEvent0AddInvocation.Verify(value.ValueSetup, times, _invocationProviders);
			}
			...
			{
				_handlerEvent0RemoveInvocation ??= new Invocation<System.EventHandler<T>?>($"IInterface<{typeof(T).Name}>.HandlerEvent.remove -= {{0}}");
				_handlerEvent0RemoveInvocation.Verify(value.ValueSetup, times, _invocationProviders);
			}
		...
		const string proxy =
			...
			public event System.EventHandler<T>? HandlerEvent
			{
				add
				{
					_mock._handlerEvent0AddInvocation ??= new Invocation<System.EventHandler<T>?>($"IInterface<{typeof(T).Name}>.HandlerEvent.add += {{0}}");
					_mock._handlerEvent0AddInvocation.Register(_mock._invocationIndex, value);
					_mock._handlerEvent0 += value;
				}
				remove
				{
					_mock._handlerEvent0RemoveInvocation ??= new Invocation<System.EventHandler<T>?>($"IInterface<{typeof(T).Name}>.HandlerEvent.remove -= {{0}}");
					_mock._handlerEvent0RemoveInvocation.Register(_mock._invocationIndex, value);
					_mock._handlerEvent0 -= value;
				}
			}
	...
	public async Task GenerateClassEvent1()
	{
		...
		const string methods =
			...
			public void VerifyAddHandlerEvent(in It<MyNihongo.Example.Tests.SampleHandler1?> value, in Times times)
			{
				_handlerEvent0AddInvocation ??= new Invocation<MyNihongo.Example.Tests.SampleHandler1?>($"Class<{typeof(T).Name}>.HandlerEvent.add += {{0}}");
				_handlerEvent0AddInvocation.Verify(value.ValueSetup, times, _invocationProviders);
			}
			...
			public void VerifyRemoveHandlerEvent(in It<MyNihongo.Example.Tests.SampleHandler1?> value, in Times times)
			{
				_handlerEvent0RemoveInvocation ??= new Invocation<MyNihongo.Example.Tests.SampleHandler1?>($"Class<{typeof(T).Name}>.HandlerEvent.remove -= {{0}}");
				_handlerEvent0RemoveInvocation.Verify(value.ValueSetup, times, _invocationProviders);
			}
		...
		const string proxy =
			...
			public override event MyNihongo.Example.Tests.SampleHandler1? HandlerEvent
			{
				add
				{
					_mock._handlerEvent0AddInvocation ??= new Invocation<MyNihongo.Example.Tests.SampleHandler1?>($"Class<{typeof(T).Name}>.HandlerEvent.add += {{0}}");
					_mock._handlerEvent0AddInvocation.Register(_mock._invocationIndex, value);
					_mock._handlerEvent0 += value;
				}
				remove
				{
					_mock._handlerEvent0RemoveInvocation ??= new Invocation<MyNihongo.Example.Tests.SampleHandler1?>($"Class<{typeof(T).Name}>.HandlerEvent.remove -= {{0}}");
					_mock._handlerEvent0RemoveInvocation.Register(_mock._invocationIndex, value);
					_mock._handlerEvent0 -= value;
				}
			}
	...
	public async Task GenerateClassGenericEvent1()
	{
		...
		const string methods =
			...
			public void VerifyAddHandlerEvent(in It<System.EventHandler<T>?> value, in Times times)
			{
				_handlerEvent0AddInvocation ??= new Invocation<System.EventHandler<T>?>($"Class<{typeof(T).Name}>.HandlerEvent.add += {{0}}");
				_handlerEvent0AddInvocation.Verify(value.ValueSetup, times, _invocationProviders);
			}
			...
			public void VerifyRemoveHandlerEvent(in It<System.EventHandler<T>?> value, in Times times)
			{
				_handlerEvent0RemoveInvocation ??= new Invocation<System.EventHandler<T>?>($"Class<{typeof(T).Name}>.HandlerEvent.remove -= {{0}}");
				_handlerEvent0RemoveInvocation.Verify(value.ValueSetup, times, _invocationProviders);
			}
		...
		const string proxy =
			...
			public override event System.EventHandler<T>? HandlerEvent
			{
				add
				{
					_mock._handlerEvent0AddInvocation ??= new Invocation<System.EventHandler<T>?>($"Class<{typeof(T).Name}>.HandlerEvent.add += {{0}}");
					_mock._handlerEvent0AddInvocation.Register(_mock._invocationIndex, value);
					_mock._handlerEvent0 += value;
				}
				remove
				{
					_mock._handlerEvent0RemoveInvocation ??= new Invocation<System.EventHandler<T>?>($"Class<{typeof(T).Name}>.HandlerEvent.remove -= {{0}}");
					_mock._handlerEvent0RemoveInvocation.Register(_mock._invocationIndex, value);
					_mock._handlerEvent0 -= value;
				}
			}
