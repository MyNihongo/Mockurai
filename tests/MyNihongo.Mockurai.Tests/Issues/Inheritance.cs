...
public sealed class Inheritance : IssuesTestsBase
{
		...
		[
			...
			(
				...
				public sealed class ClassMock<T> : IMock<Issues.Tests.Class<T>>
				{
					...
					{
						_invoke0Invocation ??= new Invocation<T>($"Class<{typeof(T).Name}>.Invoke({{0}})");
				...
				public static partial class MockExtensions
				{
					extension<T>(IMock<Issues.Tests.Class<T>> @this)
					{
						...
						public ISetup<System.Action<T>> SetupInvoke(in It<T> value = default) =>
							((ClassMock<T>)@this).SetupInvoke(value);

						public void VerifyInvoke(in It<T> value, in Times times) =>
							((ClassMock<T>)@this).VerifyInvoke(value, times);
				...
				public static partial class MockSequenceExtensions
				{
					extension<T>(IMockSequence<Issues.Tests.Class<T>> @this)
					{
						...
						{
							var nextIndex = ((ClassMock<T>)@this.Mock).VerifyInvoke(value, @this.VerifyIndex);
							@this.VerifyIndex.Set(nextIndex);
						}
					}
				}
		...
		[
			...
			(
				...
				public sealed class ClassMock : IMock<Issues.Tests.Class>
				{
					...
					// Invoke
					private SetupWithParameter<float>? _invoke0;
					private Invocation<float>? _invoke0Invocation;

					public SetupWithParameter<float> SetupInvoke(in It<float> value)
					{
						_invoke0 ??= new SetupWithParameter<float>();
						_invoke0.SetupParameter(value.ValueSetup);
						return _invoke0;
					}

					public void VerifyInvoke(in It<float> value, in Times times)
					{
						_invoke0Invocation ??= new Invocation<float>("Class.Invoke({0})");
						_invoke0Invocation.Verify(value.ValueSetup, times, _invocationProviders);
					}

					public long VerifyInvoke(in It<float> value, long index)
					{
						_invoke0Invocation ??= new Invocation<float>("Class.Invoke({0})");
						return _invoke0Invocation.Verify(value.ValueSetup, index, _invocationProviders);
					}
					...
					public sealed class InvocationContainer
					{
						...
						public System.Collections.Generic.IEnumerable<IInvocation<float>> Invoke => _mock._invoke0Invocation?.GetInvocationsWithArguments() ?? [];
					}
				}
				...
				public static partial class MockExtensions
				{
					extension(IMock<Issues.Tests.Class> @this)
					{
						...
						// Invoke
						public ISetup<System.Action<float>> SetupInvoke(in It<float> value = default) =>
							((ClassMock)@this).SetupInvoke(value);

						public void VerifyInvoke(in It<float> value, in Times times) =>
							((ClassMock)@this).VerifyInvoke(value, times);

						public void VerifyInvoke(in It<float> value, System.Func<Times> times) =>
							((ClassMock)@this).VerifyInvoke(value, times());
					}
				}
				...
				public static partial class MockSequenceExtensions
				{
					...
					{
						// Invoke
						public void Invoke(in It<float> value)
						{
							var nextIndex = ((ClassMock)@this.Mock).VerifyInvoke(value, @this.VerifyIndex);
							@this.VerifyIndex.Set(nextIndex);
						}
					}
				}
	...
	[Fact]
	public async Task AddOverrideForBaseOverride()
	{
		const string testCode =
			"""
			namespace Issues.Tests;
		...
		[
			...
			(
				...
				public sealed class ClassMock : IMock<Issues.Tests.Class>
				{
					...
					// RequestCharge
					private Setup<double>? _requestCharge0Get;
					private Invocation? _requestCharge0GetInvocation;

					public Setup<double> SetupGetRequestCharge()
					{
						_requestCharge0Get ??= new Setup<double>();
						return _requestCharge0Get;
					}

					public void VerifyGetRequestCharge(in Times times)
					{
						_requestCharge0GetInvocation ??= new Invocation("Class.RequestCharge.get");
						_requestCharge0GetInvocation.Verify(times, _invocationProviders);
					}

					public long VerifyGetRequestCharge(long index)
					{
						_requestCharge0GetInvocation ??= new Invocation("Class.RequestCharge.get");
						return _requestCharge0GetInvocation.Verify(index, _invocationProviders);
					}

					public void VerifyNoOtherCalls()
					{
						_requestCharge0GetInvocation?.VerifyNoOtherCalls(_invocationProviders);
					}

					private System.Collections.Generic.IEnumerable<IInvocationProvider?> GetInvocations()
					{
						yield return _requestCharge0GetInvocation;
					}
					...
					private sealed class Proxy : Issues.Tests.Class
					{
						...
						public override double RequestCharge
						{
							get
							{
								_mock._requestCharge0GetInvocation ??= new Invocation("Class.RequestCharge.get");
								_mock._requestCharge0GetInvocation.Register(_mock._invocationIndex);
								return _mock._requestCharge0Get?.Execute(out var returnValue) == true ? returnValue! : default!;
							}
						}
					}
					...
					public sealed class InvocationContainer
					{
						...
						public System.Collections.Generic.IEnumerable<IInvocation> RequestChargeGet => _mock._requestCharge0GetInvocation?.GetInvocations() ?? [];
					}
				}
				...
				public static partial class MockExtensions
				{
					extension(IMock<Issues.Tests.Class> @this)
					{
						...
						// RequestCharge
						public ISetup<System.Action, double, System.Func<double>> SetupGetRequestCharge() =>
							((ClassMock)@this).SetupGetRequestCharge();

						public void VerifyGetRequestCharge(in Times times) =>
							((ClassMock)@this).VerifyGetRequestCharge(times);

						public void VerifyGetRequestCharge(System.Func<Times> times) =>
							((ClassMock)@this).VerifyGetRequestCharge(times());
					}
				}
				...
				public static partial class MockSequenceExtensions
				{
					...
					{
						// RequestCharge
						public void GetRequestCharge()
						{
							var nextIndex = ((ClassMock)@this.Mock).VerifyGetRequestCharge(@this.VerifyIndex);
							@this.VerifyIndex.Set(nextIndex);
						}
					}
				}
