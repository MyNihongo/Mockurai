				...
				public sealed class InterfaceMock : IMock<MyNihongo.Mock.Tests.IInterface>
				{
					...
					private sealed class Proxy : MyNihongo.Mock.Tests.IInterface
					{
						...
						public TReturns Invoke<TReturns>(int param1, TReturns returnValue)
						{
							...
							return ((SetupInt32T1<TReturns, TReturns>?)_mock._invoke0?.GetValueOrDefault(typeof(TReturns)))?.Execute(param1, returnValue, out var _returnValue) == true ? _returnValue! : default;
						}
					}
				}
