namespace MyNihongo.Mock.Abstractions.Tests.Invocation.InvocationDictionaryTests;
...
public sealed class GetInvocationsShould
{
	...
	public void ReturnSingleType()
	{
		...
		Mock.Invocation intInvocation = new("int"), stringInvocation = new("string");
	...
	public void NotOverwriteSingleType()
	{
		...
		Mock.Invocation intInvocation1 = new("int1"), intInvocation2 = new("int2"), stringInvocation = new("string");
	...
	public void ReturnMultipleTypes()
	{
		...
		Mock.Invocation intIntInvocation = new("int-int"),
	...
	public void NotOverwriteMultipleTypes()
	{
		...
		Mock.Invocation intIntInvocation1 = new("int-int-1"),
