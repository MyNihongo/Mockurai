namespace MyNihongo.Mockurai.Sample._Generated.SetupReturnsWithSeveralParametersTests;
...
public sealed class ExecutePrimitiveShould : SetupReturnsTestsBase
{
	...
	public void ReturnForAnySetup()
	{
		...
		var fixture = CreateFixture<SetupInt32Int32<string>>();
	...
	public void ReturnDefaultForValueSetup1()
	{
		...
		var fixture = CreateFixtureInt<SetupInt32Int32<int>>();
		fixture.SetupParameters(setup1.ValueSetup, setup2.ValueSetup);
		fixture.Returns(returnValue);
	...
	[InlineData(11)]
	[InlineData(100)]
	public void ReturnNullForWhereSetupFunc1(int inputValue2)
	{
		const int setupValue2 = 987654321;
		It<int> setup1 = It<int>.Where(static x => x <= 10), setup2 = setupValue2;
	...
	public void ReturnDifferentValues()
	{
		...
		var actual1 = fixture.Execute(parameter1, parameter2, out var returnValue1);
		Assert.True(actual1);
		Assert.Equal(setupValue1, returnValue1);

		var actual2 = fixture.Execute(parameter1, parameter2, out var returnValue2);
		Assert.True(actual2);
		Assert.Equal(setupValue2, returnValue2);

		var actual3 = fixture.Execute(parameter1, parameter2, out var returnValue3);
		Assert.True(actual3);
	...
	public void ReturnDifferentValuesWithCallback1()
	{
		...
		var actual4 = fixture.Execute(parameter1, parameter2, out var returnValue4);
		Assert.True(actual4);
	...
	public void ThrowDifferentExceptionsWithCallback1()
	{
		...
		const int parameter1 = 123, parameter2 = 234;
		fixture.Execute(parameter1, parameter2, out _);
		...
		Action actual4 = () => fixture.Execute(parameter1, parameter2, out _);
	...
	public void ThrowExceptionWithReturn()
	{
		...
		var actual1 = () => { fixture.Execute(parameter1, parameter2, out _); };
