namespace MyNihongo.Mockurai.Sample._Generated.SetupWithSeveralParametersTests;
...
public sealed class InvokePrimitiveShould : SetupWithSeveralParametersTestsBase
{
	...
	public void ThrowForAnySetup()
	{
		...
		var fixture = CreateFixture<SetupInt32Int32>();
	...
	public void ThrowDifferentExceptionsWithCallback1()
	{
		...
		const int parameter1 = 123, parameter2 = 321;
		fixture.Invoke(parameter1, parameter2);
		...
		var actual4 = () => fixture.Invoke(parameter1, parameter2);
