...
public sealed class HandlerShould : PrimitiveTypeServiceTestsBase
{
	...
	public void ThrowIfInvalidFunction()
	{
		...
		const string expectedMessage =
			"""
			Expected IPrimitiveDependencyService.Handler.add += MyNihongo.Mockurai.Sample.PrimitiveHandler to be called 1 time, but instead it was called 0 times.
			Performed invocations:
			- 1: IPrimitiveDependencyService.Handler.add += MyNihongo.Mockurai.Sample.PrimitiveHandler
			- 2: IPrimitiveDependencyService.Handler.remove -= MyNihongo.Mockurai.Sample.PrimitiveHandler
			""";
	...
	public void ThrowIfInvalidSequence()
	{
		...
		const string expectedMessage =
			"""
			Expected IPrimitiveDependencyService.Handler.add += MyNihongo.Mockurai.Sample.PrimitiveHandler to be invoked at index 3, but it has not been called.
			Performed invocations:
			- 1: IPrimitiveDependencyService.Handler.add += MyNihongo.Mockurai.Sample.PrimitiveHandler
			- 2: IPrimitiveDependencyService.Handler.remove -= MyNihongo.Mockurai.Sample.PrimitiveHandler
			""";
