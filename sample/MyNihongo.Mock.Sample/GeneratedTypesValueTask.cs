...
public sealed class ValueTaskDependencyServiceMock : IMock<IValueTaskDependencyService>
{
	...
	private sealed class Proxy : IValueTaskDependencyService
	{
		...
		{
			var hashCode = ct.GetHashCode();
			return _mock._returnPrimitiveAsync?.TryGetValue(hashCode, out var returnValue) == true ? ValueTask.FromResult(returnValue) : throw new NullReferenceException("IValueTaskDependencyService#ReturnPrimitiveAsync() method has not been set up");
		}

		public ValueTask<short?> ReturnPrimitiveNullableAsync(CancellationToken ct = default)
		{
			var hashCode = ct.GetHashCode();
			return _mock._returnPrimitiveNullableAsync?.TryGetValue(hashCode, out var returnValue) == true ? ValueTask.FromResult(returnValue) : ValueTask.FromResult<short?>(null);
		}

		public ValueTask<StructReturn> ReturnStructAsync(CancellationToken ct = default)
		{
			var hashCode = ct.GetHashCode();
			return _mock._returnStructAsync?.TryGetValue(hashCode, out var returnValue) == true ? ValueTask.FromResult(returnValue) : throw new NullReferenceException("IValueTaskDependencyService#ReturnStructAsync() method has not been set up");
		}

		public ValueTask<StructReturn?> ReturnStructNullableAsync(CancellationToken ct = default)
		{
			var hashCode = ct.GetHashCode();
			return _mock._returnStructNullableAsync?.TryGetValue(hashCode, out var returnValue) == true ? ValueTask.FromResult(returnValue) : ValueTask.FromResult<StructReturn?>(null);
		}

		public ValueTask<ClassReturn> ReturnClassAsync(CancellationToken ct = default)
		{
			var hashCode = ct.GetHashCode();
			return _mock._returnClassAsync?.TryGetValue(hashCode, out var returnValue) == true ? ValueTask.FromResult(returnValue) : throw new NullReferenceException("IValueTaskDependencyService#ReturnClassAsync() method has not been set up");
		}

		public ValueTask<ClassReturn?> ReturnClassNullableAsync(CancellationToken ct = default)
		{
			var hashCode = ct.GetHashCode();
			return _mock._returnClassNullableAsync?.TryGetValue(hashCode, out var returnValue) == true ? ValueTask.FromResult(returnValue) : ValueTask.FromResult<ClassReturn?>(null);
		}

		public ValueTask<RecordReturn> ReturnRecordAsync(CancellationToken ct = default)
		{
			var hashCode = ct.GetHashCode();
			return _mock._returnRecordAsync?.TryGetValue(hashCode, out var returnValue) == true ? ValueTask.FromResult(returnValue) : throw new NullReferenceException("IValueTaskDependencyService#ReturnRecordAsync() method has not been set up");
		}

		public ValueTask<RecordReturn?> ReturnRecordNullableAsync(CancellationToken ct = default)
		{
			var hashCode = ct.GetHashCode();
			return _mock._returnRecordNullableAsync?.TryGetValue(hashCode, out var returnValue) == true ? ValueTask.FromResult(returnValue) : ValueTask.FromResult<RecordReturn?>(null);
		}
	}
}
...
{
	public static SetupWithParameter<int> SetupReturnPrimitiveAsync(this IMock<IValueTaskDependencyService> @this, in CancellationToken ct) =>
		((ValueTaskDependencyServiceMock)@this).SetupReturnPrimitiveAsync(ct);

	public static SetupWithParameter<short?> SetupReturnPrimitiveNullableAsync(this IMock<IValueTaskDependencyService> @this, in CancellationToken ct) =>
		((ValueTaskDependencyServiceMock)@this).SetupReturnPrimitiveNullableAsync(ct);

	public static SetupWithParameter<StructReturn> SetupReturnStructAsync(this IMock<IValueTaskDependencyService> @this, in CancellationToken ct) =>
		((ValueTaskDependencyServiceMock)@this).SetupReturnStructAsync(ct);

	public static SetupWithParameter<StructReturn?> SetupReturnStructNullableAsync(this IMock<IValueTaskDependencyService> @this, in CancellationToken ct) =>
		((ValueTaskDependencyServiceMock)@this).SetupReturnStructNullableAsync(ct);

	public static SetupWithParameter<ClassReturn> SetupReturnClassAsync(this IMock<IValueTaskDependencyService> @this, in CancellationToken ct) =>
		((ValueTaskDependencyServiceMock)@this).SetupReturnClassAsync(ct);

	public static SetupWithParameter<ClassReturn?> SetupReturnClassNullableAsync(this IMock<IValueTaskDependencyService> @this, in CancellationToken ct) =>
		((ValueTaskDependencyServiceMock)@this).SetupReturnClassNullableAsync(ct);

	public static SetupWithParameter<RecordReturn> SetupReturnRecordAsync(this IMock<IValueTaskDependencyService> @this, in CancellationToken ct) =>
		((ValueTaskDependencyServiceMock)@this).SetupReturnRecordAsync(ct);

	public static SetupWithParameter<RecordReturn?> SetupReturnRecordNullableAsync(this IMock<IValueTaskDependencyService> @this, in CancellationToken ct) =>
