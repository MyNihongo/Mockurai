...
/// <summary>
/// A returning mock setup that matches a single argument, invokes <see cref="Action{TParameter}"/> callbacks,
/// and computes return values via <see cref="Func{TParameter, TReturns}"/>.
/// </summary>
